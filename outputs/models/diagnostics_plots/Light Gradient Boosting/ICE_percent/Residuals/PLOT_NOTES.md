# Plot Notes — `models/diagnostics_plots/Light Gradient Boosting/ICE_percent/Residuals`
...
### `Absolute Error Versus Thickness__Light Gradient Boosting__ICE_percent.png`
...
### `Residuals Versus Actual__Light Gradient Boosting__ICE_percent.png`
...
### `Residuals Versus Predicted__Light Gradient Boosting__ICE_percent.png`
...
### `Residuals Versus Thickness__Light Gradient Boosting__ICE_percent.png`
