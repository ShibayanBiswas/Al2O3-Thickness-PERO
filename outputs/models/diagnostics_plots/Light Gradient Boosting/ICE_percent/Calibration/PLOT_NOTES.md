# Plot Notes — `models/diagnostics_plots/Light Gradient Boosting/ICE_percent/Calibration`
...
### `Parity Plot__Light Gradient Boosting__ICE_percent.png`
...
### `Sorted Actual And Predicted__Light Gradient Boosting__ICE_percent.png`
