# Plot Notes — `models/diagnostics_plots/Light Gradient Boosting/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Light Gradient Boosting__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Light Gradient Boosting__Highest Capacity Retention_percent.png`
