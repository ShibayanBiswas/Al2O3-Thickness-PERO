# Plot Notes — `models/diagnostics_plots/Light Gradient Boosting/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Light Gradient Boosting__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Light Gradient Boosting__Rct_initial_ohm.png`
