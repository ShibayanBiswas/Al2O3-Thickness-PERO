# Plot Notes — `models/diagnostics_plots/Light Gradient Boosting/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Light Gradient Boosting__Rct_initial_ohm.png`
...
### `QQ Plot__Light Gradient Boosting__Rct_initial_ohm.png`
...
### `Residual Box Plot__Light Gradient Boosting__Rct_initial_ohm.png`
...
### `Residual Distribution__Light Gradient Boosting__Rct_initial_ohm.png`
