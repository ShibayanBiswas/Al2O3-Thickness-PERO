# Plot Notes — `models/diagnostics_plots/Light Gradient Boosting/Rct_initial_ohm/Residuals`
...
### `Absolute Error Versus Thickness__Light Gradient Boosting__Rct_initial_ohm.png`
...
### `Residuals Versus Actual__Light Gradient Boosting__Rct_initial_ohm.png`
...
### `Residuals Versus Predicted__Light Gradient Boosting__Rct_initial_ohm.png`
...
### `Residuals Versus Thickness__Light Gradient Boosting__Rct_initial_ohm.png`
