# Plot Notes — `models/diagnostics_plots/Gradient Boosting/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Gradient Boosting__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Gradient Boosting__Rct_initial_ohm.png`
