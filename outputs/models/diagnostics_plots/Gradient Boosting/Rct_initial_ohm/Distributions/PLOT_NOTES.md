# Plot Notes — `models/diagnostics_plots/Gradient Boosting/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Gradient Boosting__Rct_initial_ohm.png`
...
### `QQ Plot__Gradient Boosting__Rct_initial_ohm.png`
...
### `Residual Box Plot__Gradient Boosting__Rct_initial_ohm.png`
...
### `Residual Distribution__Gradient Boosting__Rct_initial_ohm.png`
