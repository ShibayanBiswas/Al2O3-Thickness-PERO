# Plot Notes — `models/diagnostics_plots/Gradient Boosting/ICE_percent/Calibration`
...
### `Parity Plot__Gradient Boosting__ICE_percent.png`
...
### `Sorted Actual And Predicted__Gradient Boosting__ICE_percent.png`
