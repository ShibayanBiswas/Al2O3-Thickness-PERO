# Plot Notes — `models/diagnostics_plots/Gradient Boosting/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Gradient Boosting__ICE_percent.png`
...
### `QQ Plot__Gradient Boosting__ICE_percent.png`
...
### `Residual Box Plot__Gradient Boosting__ICE_percent.png`
...
### `Residual Distribution__Gradient Boosting__ICE_percent.png`
