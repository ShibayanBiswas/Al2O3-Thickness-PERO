# Plot Notes — `models/diagnostics_plots/Gradient Boosting/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Gradient Boosting__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Gradient Boosting__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Gradient Boosting__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Gradient Boosting__Highest Capacity Retention_percent.png`
