# Plot Notes — `models/diagnostics_plots/Gradient Boosting/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Gradient Boosting__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Gradient Boosting__Highest Capacity Retention_percent.png`
