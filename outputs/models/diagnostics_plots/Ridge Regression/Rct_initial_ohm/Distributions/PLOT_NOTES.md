# Plot Notes — `models/diagnostics_plots/Ridge Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Ridge Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Ridge Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Ridge Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Ridge Regression__Rct_initial_ohm.png`
