# Plot Notes — `models/diagnostics_plots/Ridge Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Ridge Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Ridge Regression__Rct_initial_ohm.png`
