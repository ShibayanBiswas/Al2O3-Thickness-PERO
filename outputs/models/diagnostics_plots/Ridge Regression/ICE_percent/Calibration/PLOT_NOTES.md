# Plot Notes — `models/diagnostics_plots/Ridge Regression/ICE_percent/Calibration`
...
### `Parity Plot__Ridge Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__Ridge Regression__ICE_percent.png`
