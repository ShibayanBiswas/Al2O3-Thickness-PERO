# Plot Notes — `models/diagnostics_plots/Ridge Regression/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Ridge Regression__ICE_percent.png`
...
### `QQ Plot__Ridge Regression__ICE_percent.png`
...
### `Residual Box Plot__Ridge Regression__ICE_percent.png`
...
### `Residual Distribution__Ridge Regression__ICE_percent.png`
