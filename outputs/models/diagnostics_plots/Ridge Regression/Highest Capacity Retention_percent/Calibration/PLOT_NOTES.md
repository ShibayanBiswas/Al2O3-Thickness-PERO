# Plot Notes — `models/diagnostics_plots/Ridge Regression/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Ridge Regression__Highest Capacity Retention_percent.png`
