# Plot Notes — `models/diagnostics_plots/Ridge Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Ridge Regression__Highest Capacity Retention_percent.png`
