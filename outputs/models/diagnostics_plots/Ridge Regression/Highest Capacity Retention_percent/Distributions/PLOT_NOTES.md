# Plot Notes — `models/diagnostics_plots/Ridge Regression/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__Ridge Regression__Highest Capacity Retention_percent.png`
...
### `QQ Plot__Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__Ridge Regression__Highest Capacity Retention_percent.png`
