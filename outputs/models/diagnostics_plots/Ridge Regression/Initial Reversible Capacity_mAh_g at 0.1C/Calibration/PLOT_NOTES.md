# Plot Notes — `models/diagnostics_plots/Ridge Regression/Initial Reversible Capacity_mAh_g at 0.1C/Calibration`
...
### `Parity Plot__Ridge Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Sorted Actual And Predicted__Ridge Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
