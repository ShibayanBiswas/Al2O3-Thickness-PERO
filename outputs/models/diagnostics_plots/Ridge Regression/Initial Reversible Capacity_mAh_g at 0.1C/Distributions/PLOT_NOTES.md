# Plot Notes — `models/diagnostics_plots/Ridge Regression/Initial Reversible Capacity_mAh_g at 0.1C/Distributions`
...
### `Predicted And Actual Density__Ridge Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `QQ Plot__Ridge Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Box Plot__Ridge Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Distribution__Ridge Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
