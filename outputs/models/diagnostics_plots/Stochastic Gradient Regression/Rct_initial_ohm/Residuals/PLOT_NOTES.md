# Plot Notes — `models/diagnostics_plots/Stochastic Gradient Regression/Rct_initial_ohm/Residuals`
...
### `Absolute Error Versus Thickness__Stochastic Gradient Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Actual__Stochastic Gradient Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Predicted__Stochastic Gradient Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Thickness__Stochastic Gradient Regression__Rct_initial_ohm.png`
