# Plot Notes — `models/diagnostics_plots/Stochastic Gradient Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Stochastic Gradient Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Stochastic Gradient Regression__Rct_initial_ohm.png`
