# Plot Notes — `models/diagnostics_plots/Stochastic Gradient Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Stochastic Gradient Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Stochastic Gradient Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Stochastic Gradient Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Stochastic Gradient Regression__Rct_initial_ohm.png`
