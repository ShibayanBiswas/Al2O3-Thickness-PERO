# Plot Notes — `models/diagnostics_plots/Stochastic Gradient Regression/Initial Reversible Capacity_mAh_g at 0.1C/Distributions`
...
### `Predicted And Actual Density__Stochastic Gradient Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `QQ Plot__Stochastic Gradient Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Box Plot__Stochastic Gradient Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Distribution__Stochastic Gradient Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
