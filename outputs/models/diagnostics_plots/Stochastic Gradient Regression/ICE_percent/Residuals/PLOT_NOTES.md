# Plot Notes — `models/diagnostics_plots/Stochastic Gradient Regression/ICE_percent/Residuals`
...
### `Absolute Error Versus Thickness__Stochastic Gradient Regression__ICE_percent.png`
...
### `Residuals Versus Actual__Stochastic Gradient Regression__ICE_percent.png`
...
### `Residuals Versus Predicted__Stochastic Gradient Regression__ICE_percent.png`
...
### `Residuals Versus Thickness__Stochastic Gradient Regression__ICE_percent.png`
