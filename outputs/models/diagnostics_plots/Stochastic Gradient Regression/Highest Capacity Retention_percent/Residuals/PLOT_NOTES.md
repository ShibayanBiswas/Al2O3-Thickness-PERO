# Plot Notes — `models/diagnostics_plots/Stochastic Gradient Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Stochastic Gradient Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Stochastic Gradient Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Stochastic Gradient Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Stochastic Gradient Regression__Highest Capacity Retention_percent.png`
