# Plot Notes — `models/diagnostics_plots/Stochastic Gradient Regression/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Stochastic Gradient Regression__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Stochastic Gradient Regression__Highest Capacity Retention_percent.png`
