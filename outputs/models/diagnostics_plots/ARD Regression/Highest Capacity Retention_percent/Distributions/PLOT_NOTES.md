# Plot Notes — `models/diagnostics_plots/ARD Regression/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__ARD Regression__Highest Capacity Retention_percent.png`
...
### `QQ Plot__ARD Regression__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__ARD Regression__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__ARD Regression__Highest Capacity Retention_percent.png`
