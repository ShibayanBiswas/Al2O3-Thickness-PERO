# Plot Notes — `models/diagnostics_plots/ARD Regression/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__ARD Regression__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__ARD Regression__Highest Capacity Retention_percent.png`
