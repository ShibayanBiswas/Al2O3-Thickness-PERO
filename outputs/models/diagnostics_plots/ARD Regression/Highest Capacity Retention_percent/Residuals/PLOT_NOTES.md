# Plot Notes — `models/diagnostics_plots/ARD Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__ARD Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__ARD Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__ARD Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__ARD Regression__Highest Capacity Retention_percent.png`
