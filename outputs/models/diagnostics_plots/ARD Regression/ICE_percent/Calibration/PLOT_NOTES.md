# Plot Notes — `models/diagnostics_plots/ARD Regression/ICE_percent/Calibration`
...
### `Parity Plot__ARD Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__ARD Regression__ICE_percent.png`
