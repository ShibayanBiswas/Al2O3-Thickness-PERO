# Plot Notes — `models/diagnostics_plots/ARD Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__ARD Regression__Rct_initial_ohm.png`
...
### `QQ Plot__ARD Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__ARD Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__ARD Regression__Rct_initial_ohm.png`
