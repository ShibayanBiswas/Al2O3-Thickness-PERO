# Plot Notes — `models/diagnostics_plots/ARD Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__ARD Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__ARD Regression__Rct_initial_ohm.png`
