# Plot Notes — `models/diagnostics_plots/ARD Regression/Initial Reversible Capacity_mAh_g at 0.1C/Residuals`
...
### `Absolute Error Versus Thickness__ARD Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Actual__ARD Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Predicted__ARD Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Thickness__ARD Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
