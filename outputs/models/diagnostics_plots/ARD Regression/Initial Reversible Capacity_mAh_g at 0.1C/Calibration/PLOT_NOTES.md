# Plot Notes — `models/diagnostics_plots/ARD Regression/Initial Reversible Capacity_mAh_g at 0.1C/Calibration`
...
### `Parity Plot__ARD Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Sorted Actual And Predicted__ARD Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
