# Plot Notes — `models/diagnostics_plots/Polynomial Ridge Degree 2/Initial Reversible Capacity_mAh_g at 0.1C/Residuals`
...
### `Absolute Error Versus Thickness__Polynomial Ridge Degree 2__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Actual__Polynomial Ridge Degree 2__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Predicted__Polynomial Ridge Degree 2__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Thickness__Polynomial Ridge Degree 2__Initial Reversible Capacity_mAh_g at 0.1C.png`
