# Plot Notes — `models/diagnostics_plots/Polynomial Ridge Degree 2/ICE_percent/Calibration`
...
### `Parity Plot__Polynomial Ridge Degree 2__ICE_percent.png`
...
### `Sorted Actual And Predicted__Polynomial Ridge Degree 2__ICE_percent.png`
