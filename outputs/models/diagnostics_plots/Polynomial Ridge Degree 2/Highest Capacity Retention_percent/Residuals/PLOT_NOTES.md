# Plot Notes — `models/diagnostics_plots/Polynomial Ridge Degree 2/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Polynomial Ridge Degree 2__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Polynomial Ridge Degree 2__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Polynomial Ridge Degree 2__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Polynomial Ridge Degree 2__Highest Capacity Retention_percent.png`
