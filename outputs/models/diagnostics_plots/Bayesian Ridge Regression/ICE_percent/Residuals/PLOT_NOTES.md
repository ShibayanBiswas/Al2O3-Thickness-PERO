# Plot Notes — `models/diagnostics_plots/Bayesian Ridge Regression/ICE_percent/Residuals`
...
### `Absolute Error Versus Thickness__Bayesian Ridge Regression__ICE_percent.png`
...
### `Residuals Versus Actual__Bayesian Ridge Regression__ICE_percent.png`
...
### `Residuals Versus Predicted__Bayesian Ridge Regression__ICE_percent.png`
...
### `Residuals Versus Thickness__Bayesian Ridge Regression__ICE_percent.png`
