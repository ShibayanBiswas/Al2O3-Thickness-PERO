# Plot Notes — `models/diagnostics_plots/Bayesian Ridge Regression/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Bayesian Ridge Regression__ICE_percent.png`
...
### `QQ Plot__Bayesian Ridge Regression__ICE_percent.png`
...
### `Residual Box Plot__Bayesian Ridge Regression__ICE_percent.png`
...
### `Residual Distribution__Bayesian Ridge Regression__ICE_percent.png`
