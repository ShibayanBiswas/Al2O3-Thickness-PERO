# Plot Notes — `models/diagnostics_plots/Bayesian Ridge Regression/ICE_percent/Calibration`
...
### `Parity Plot__Bayesian Ridge Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__Bayesian Ridge Regression__ICE_percent.png`
