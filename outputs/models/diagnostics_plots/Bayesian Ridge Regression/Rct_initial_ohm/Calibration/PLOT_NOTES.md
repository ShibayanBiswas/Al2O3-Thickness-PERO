# Plot Notes — `models/diagnostics_plots/Bayesian Ridge Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Bayesian Ridge Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Bayesian Ridge Regression__Rct_initial_ohm.png`
