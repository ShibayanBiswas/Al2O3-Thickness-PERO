# Plot Notes — `models/diagnostics_plots/Bayesian Ridge Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Bayesian Ridge Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Bayesian Ridge Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Bayesian Ridge Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Bayesian Ridge Regression__Rct_initial_ohm.png`
