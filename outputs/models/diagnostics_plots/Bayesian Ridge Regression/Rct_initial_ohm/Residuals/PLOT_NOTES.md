# Plot Notes — `models/diagnostics_plots/Bayesian Ridge Regression/Rct_initial_ohm/Residuals`
...
### `Absolute Error Versus Thickness__Bayesian Ridge Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Actual__Bayesian Ridge Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Predicted__Bayesian Ridge Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Thickness__Bayesian Ridge Regression__Rct_initial_ohm.png`
