# Plot Notes — `models/diagnostics_plots/Bayesian Ridge Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Bayesian Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Bayesian Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Bayesian Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Bayesian Ridge Regression__Highest Capacity Retention_percent.png`
