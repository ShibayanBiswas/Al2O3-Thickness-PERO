# Plot Notes — `models/diagnostics_plots/Histogram Gradient Boosting/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Histogram Gradient Boosting__Rct_initial_ohm.png`
...
### `QQ Plot__Histogram Gradient Boosting__Rct_initial_ohm.png`
...
### `Residual Box Plot__Histogram Gradient Boosting__Rct_initial_ohm.png`
...
### `Residual Distribution__Histogram Gradient Boosting__Rct_initial_ohm.png`
