# Plot Notes — `models/diagnostics_plots/Histogram Gradient Boosting/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Histogram Gradient Boosting__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Histogram Gradient Boosting__Highest Capacity Retention_percent.png`
