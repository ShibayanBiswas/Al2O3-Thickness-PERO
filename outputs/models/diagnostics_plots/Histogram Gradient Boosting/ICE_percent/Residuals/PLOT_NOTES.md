# Plot Notes — `models/diagnostics_plots/Histogram Gradient Boosting/ICE_percent/Residuals`
...
### `Absolute Error Versus Thickness__Histogram Gradient Boosting__ICE_percent.png`
...
### `Residuals Versus Actual__Histogram Gradient Boosting__ICE_percent.png`
...
### `Residuals Versus Predicted__Histogram Gradient Boosting__ICE_percent.png`
...
### `Residuals Versus Thickness__Histogram Gradient Boosting__ICE_percent.png`
