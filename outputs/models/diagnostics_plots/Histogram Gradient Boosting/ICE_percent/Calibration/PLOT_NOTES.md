# Plot Notes — `models/diagnostics_plots/Histogram Gradient Boosting/ICE_percent/Calibration`
...
### `Parity Plot__Histogram Gradient Boosting__ICE_percent.png`
...
### `Sorted Actual And Predicted__Histogram Gradient Boosting__ICE_percent.png`
