# Plot Notes — `models/diagnostics_plots/Histogram Gradient Boosting/Initial Reversible Capacity_mAh_g at 0.1C/Residuals`
...
### `Absolute Error Versus Thickness__Histogram Gradient Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Actual__Histogram Gradient Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Predicted__Histogram Gradient Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Thickness__Histogram Gradient Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
