# Plot Notes — `models/diagnostics_plots/Adaptive Boosting/Initial Reversible Capacity_mAh_g at 0.1C/Residuals`
...
### `Absolute Error Versus Thickness__Adaptive Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Actual__Adaptive Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Predicted__Adaptive Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Thickness__Adaptive Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
