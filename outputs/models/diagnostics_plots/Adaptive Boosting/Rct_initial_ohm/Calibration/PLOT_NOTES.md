# Plot Notes — `models/diagnostics_plots/Adaptive Boosting/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Adaptive Boosting__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Adaptive Boosting__Rct_initial_ohm.png`
