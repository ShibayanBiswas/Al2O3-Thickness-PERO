# Plot Notes — `models/diagnostics_plots/Adaptive Boosting/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Adaptive Boosting__Rct_initial_ohm.png`
...
### `QQ Plot__Adaptive Boosting__Rct_initial_ohm.png`
...
### `Residual Box Plot__Adaptive Boosting__Rct_initial_ohm.png`
...
### `Residual Distribution__Adaptive Boosting__Rct_initial_ohm.png`
