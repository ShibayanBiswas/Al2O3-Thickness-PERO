# Plot Notes — `models/diagnostics_plots/Adaptive Boosting/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Adaptive Boosting__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Adaptive Boosting__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Adaptive Boosting__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Adaptive Boosting__Highest Capacity Retention_percent.png`
