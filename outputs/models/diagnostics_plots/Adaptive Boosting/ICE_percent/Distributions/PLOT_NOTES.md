# Plot Notes — `models/diagnostics_plots/Adaptive Boosting/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Adaptive Boosting__ICE_percent.png`
...
### `QQ Plot__Adaptive Boosting__ICE_percent.png`
...
### `Residual Box Plot__Adaptive Boosting__ICE_percent.png`
...
### `Residual Distribution__Adaptive Boosting__ICE_percent.png`
