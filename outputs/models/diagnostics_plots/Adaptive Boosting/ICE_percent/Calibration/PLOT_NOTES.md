# Plot Notes — `models/diagnostics_plots/Adaptive Boosting/ICE_percent/Calibration`
...
### `Parity Plot__Adaptive Boosting__ICE_percent.png`
...
### `Sorted Actual And Predicted__Adaptive Boosting__ICE_percent.png`
