# Plot Notes — `models/diagnostics_plots/Linear Regression/Initial Reversible Capacity_mAh_g at 0.1C/Distributions`
...
### `Predicted And Actual Density__Linear Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `QQ Plot__Linear Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Box Plot__Linear Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Distribution__Linear Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
