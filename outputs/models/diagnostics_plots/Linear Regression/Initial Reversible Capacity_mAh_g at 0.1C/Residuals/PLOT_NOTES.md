# Plot Notes — `models/diagnostics_plots/Linear Regression/Initial Reversible Capacity_mAh_g at 0.1C/Residuals`
...
### `Absolute Error Versus Thickness__Linear Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Actual__Linear Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Predicted__Linear Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Thickness__Linear Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
