# Plot Notes — `models/diagnostics_plots/Linear Regression/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__Linear Regression__Highest Capacity Retention_percent.png`
...
### `QQ Plot__Linear Regression__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__Linear Regression__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__Linear Regression__Highest Capacity Retention_percent.png`
