# Plot Notes — `models/diagnostics_plots/Linear Regression/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Linear Regression__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Linear Regression__Highest Capacity Retention_percent.png`
