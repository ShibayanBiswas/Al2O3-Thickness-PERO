# Plot Notes — `models/diagnostics_plots/Linear Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Linear Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Linear Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Linear Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Linear Regression__Highest Capacity Retention_percent.png`
