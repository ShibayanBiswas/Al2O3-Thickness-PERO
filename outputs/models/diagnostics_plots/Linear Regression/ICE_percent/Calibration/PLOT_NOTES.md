# Plot Notes — `models/diagnostics_plots/Linear Regression/ICE_percent/Calibration`
...
### `Parity Plot__Linear Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__Linear Regression__ICE_percent.png`
