# Plot Notes — `models/diagnostics_plots/Linear Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Linear Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Linear Regression__Rct_initial_ohm.png`
