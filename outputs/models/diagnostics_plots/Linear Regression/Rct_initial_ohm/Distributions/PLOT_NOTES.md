# Plot Notes — `models/diagnostics_plots/Linear Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Linear Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Linear Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Linear Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Linear Regression__Rct_initial_ohm.png`
