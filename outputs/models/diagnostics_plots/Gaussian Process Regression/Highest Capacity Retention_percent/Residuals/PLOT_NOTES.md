# Plot Notes — `models/diagnostics_plots/Gaussian Process Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Gaussian Process Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Gaussian Process Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Gaussian Process Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Gaussian Process Regression__Highest Capacity Retention_percent.png`
