# Plot Notes — `models/diagnostics_plots/Gaussian Process Regression/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Gaussian Process Regression__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Gaussian Process Regression__Highest Capacity Retention_percent.png`
