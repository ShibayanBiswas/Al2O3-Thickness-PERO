# Plot Notes — `models/diagnostics_plots/Gaussian Process Regression/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__Gaussian Process Regression__Highest Capacity Retention_percent.png`
...
### `QQ Plot__Gaussian Process Regression__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__Gaussian Process Regression__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__Gaussian Process Regression__Highest Capacity Retention_percent.png`
