# Plot Notes — `models/diagnostics_plots/Gaussian Process Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Gaussian Process Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Gaussian Process Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Gaussian Process Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Gaussian Process Regression__Rct_initial_ohm.png`
