# Plot Notes — `models/diagnostics_plots/Gaussian Process Regression/Rct_initial_ohm/Residuals`
...
### `Absolute Error Versus Thickness__Gaussian Process Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Actual__Gaussian Process Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Predicted__Gaussian Process Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Thickness__Gaussian Process Regression__Rct_initial_ohm.png`
