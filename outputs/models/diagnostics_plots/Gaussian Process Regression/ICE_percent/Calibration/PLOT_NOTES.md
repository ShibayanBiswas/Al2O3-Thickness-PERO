# Plot Notes — `models/diagnostics_plots/Gaussian Process Regression/ICE_percent/Calibration`
...
### `Parity Plot__Gaussian Process Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__Gaussian Process Regression__ICE_percent.png`
