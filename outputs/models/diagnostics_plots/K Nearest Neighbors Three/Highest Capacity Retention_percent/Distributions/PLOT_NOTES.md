# Plot Notes — `models/diagnostics_plots/K Nearest Neighbors Three/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__K Nearest Neighbors Three__Highest Capacity Retention_percent.png`
...
### `QQ Plot__K Nearest Neighbors Three__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__K Nearest Neighbors Three__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__K Nearest Neighbors Three__Highest Capacity Retention_percent.png`
