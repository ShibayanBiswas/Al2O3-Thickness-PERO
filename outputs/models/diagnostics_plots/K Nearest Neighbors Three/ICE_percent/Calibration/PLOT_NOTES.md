# Plot Notes — `models/diagnostics_plots/K Nearest Neighbors Three/ICE_percent/Calibration`
...
### `Parity Plot__K Nearest Neighbors Three__ICE_percent.png`
...
### `Sorted Actual And Predicted__K Nearest Neighbors Three__ICE_percent.png`
