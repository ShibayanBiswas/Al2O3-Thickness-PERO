# Plot Notes — `models/diagnostics_plots/K Nearest Neighbors Three/Initial Reversible Capacity_mAh_g at 0.1C/Distributions`
...
### `Predicted And Actual Density__K Nearest Neighbors Three__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `QQ Plot__K Nearest Neighbors Three__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Box Plot__K Nearest Neighbors Three__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Distribution__K Nearest Neighbors Three__Initial Reversible Capacity_mAh_g at 0.1C.png`
