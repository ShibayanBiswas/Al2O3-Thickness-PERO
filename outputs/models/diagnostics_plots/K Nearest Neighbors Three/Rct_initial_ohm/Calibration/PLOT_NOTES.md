# Plot Notes — `models/diagnostics_plots/K Nearest Neighbors Three/Rct_initial_ohm/Calibration`
...
### `Parity Plot__K Nearest Neighbors Three__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__K Nearest Neighbors Three__Rct_initial_ohm.png`
