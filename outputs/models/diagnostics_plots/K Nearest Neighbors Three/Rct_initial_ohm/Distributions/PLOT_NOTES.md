# Plot Notes — `models/diagnostics_plots/K Nearest Neighbors Three/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__K Nearest Neighbors Three__Rct_initial_ohm.png`
...
### `QQ Plot__K Nearest Neighbors Three__Rct_initial_ohm.png`
...
### `Residual Box Plot__K Nearest Neighbors Three__Rct_initial_ohm.png`
...
### `Residual Distribution__K Nearest Neighbors Three__Rct_initial_ohm.png`
