# Plot Notes — `models/diagnostics_plots/Elastic Net Regression/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Elastic Net Regression__ICE_percent.png`
...
### `QQ Plot__Elastic Net Regression__ICE_percent.png`
...
### `Residual Box Plot__Elastic Net Regression__ICE_percent.png`
...
### `Residual Distribution__Elastic Net Regression__ICE_percent.png`
