# Plot Notes — `models/diagnostics_plots/Elastic Net Regression/ICE_percent/Calibration`
...
### `Parity Plot__Elastic Net Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__Elastic Net Regression__ICE_percent.png`
