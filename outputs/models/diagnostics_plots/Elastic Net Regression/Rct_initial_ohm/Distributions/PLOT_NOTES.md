# Plot Notes — `models/diagnostics_plots/Elastic Net Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Elastic Net Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Elastic Net Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Elastic Net Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Elastic Net Regression__Rct_initial_ohm.png`
