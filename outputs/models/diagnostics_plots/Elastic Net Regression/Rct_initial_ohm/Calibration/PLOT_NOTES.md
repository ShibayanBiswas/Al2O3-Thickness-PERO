# Plot Notes — `models/diagnostics_plots/Elastic Net Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Elastic Net Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Elastic Net Regression__Rct_initial_ohm.png`
