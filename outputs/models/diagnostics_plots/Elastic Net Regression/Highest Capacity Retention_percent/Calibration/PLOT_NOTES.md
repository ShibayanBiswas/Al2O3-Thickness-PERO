# Plot Notes — `models/diagnostics_plots/Elastic Net Regression/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Elastic Net Regression__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Elastic Net Regression__Highest Capacity Retention_percent.png`
