# Plot Notes — `models/diagnostics_plots/Elastic Net Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Elastic Net Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Elastic Net Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Elastic Net Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Elastic Net Regression__Highest Capacity Retention_percent.png`
