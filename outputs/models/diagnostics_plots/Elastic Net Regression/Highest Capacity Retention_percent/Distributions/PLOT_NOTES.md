# Plot Notes — `models/diagnostics_plots/Elastic Net Regression/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__Elastic Net Regression__Highest Capacity Retention_percent.png`
...
### `QQ Plot__Elastic Net Regression__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__Elastic Net Regression__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__Elastic Net Regression__Highest Capacity Retention_percent.png`
