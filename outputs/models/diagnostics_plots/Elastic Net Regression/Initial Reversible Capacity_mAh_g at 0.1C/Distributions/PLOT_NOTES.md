# Plot Notes — `models/diagnostics_plots/Elastic Net Regression/Initial Reversible Capacity_mAh_g at 0.1C/Distributions`
...
### `Predicted And Actual Density__Elastic Net Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `QQ Plot__Elastic Net Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Box Plot__Elastic Net Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Distribution__Elastic Net Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
