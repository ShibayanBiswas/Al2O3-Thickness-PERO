# Plot Notes — `models/diagnostics_plots/Random Forest/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__Random Forest__Highest Capacity Retention_percent.png`
...
### `QQ Plot__Random Forest__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__Random Forest__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__Random Forest__Highest Capacity Retention_percent.png`
