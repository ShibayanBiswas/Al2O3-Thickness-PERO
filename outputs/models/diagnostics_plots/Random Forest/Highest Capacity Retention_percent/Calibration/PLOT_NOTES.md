# Plot Notes — `models/diagnostics_plots/Random Forest/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Random Forest__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Random Forest__Highest Capacity Retention_percent.png`
