# Plot Notes — `models/diagnostics_plots/Random Forest/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Random Forest__Rct_initial_ohm.png`
...
### `QQ Plot__Random Forest__Rct_initial_ohm.png`
...
### `Residual Box Plot__Random Forest__Rct_initial_ohm.png`
...
### `Residual Distribution__Random Forest__Rct_initial_ohm.png`
