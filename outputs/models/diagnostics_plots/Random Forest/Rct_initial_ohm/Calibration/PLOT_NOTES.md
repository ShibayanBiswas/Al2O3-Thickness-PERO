# Plot Notes — `models/diagnostics_plots/Random Forest/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Random Forest__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Random Forest__Rct_initial_ohm.png`
