# Plot Notes — `models/diagnostics_plots/Bagging Regressor/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Bagging Regressor__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Bagging Regressor__Rct_initial_ohm.png`
