# Plot Notes — `models/diagnostics_plots/Bagging Regressor/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Bagging Regressor__Rct_initial_ohm.png`
...
### `QQ Plot__Bagging Regressor__Rct_initial_ohm.png`
...
### `Residual Box Plot__Bagging Regressor__Rct_initial_ohm.png`
...
### `Residual Distribution__Bagging Regressor__Rct_initial_ohm.png`
