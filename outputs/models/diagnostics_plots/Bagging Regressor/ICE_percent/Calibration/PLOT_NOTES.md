# Plot Notes — `models/diagnostics_plots/Bagging Regressor/ICE_percent/Calibration`
...
### `Parity Plot__Bagging Regressor__ICE_percent.png`
...
### `Sorted Actual And Predicted__Bagging Regressor__ICE_percent.png`
