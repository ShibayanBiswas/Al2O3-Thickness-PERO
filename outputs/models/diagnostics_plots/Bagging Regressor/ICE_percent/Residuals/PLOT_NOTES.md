# Plot Notes — `models/diagnostics_plots/Bagging Regressor/ICE_percent/Residuals`
...
### `Absolute Error Versus Thickness__Bagging Regressor__ICE_percent.png`
...
### `Residuals Versus Actual__Bagging Regressor__ICE_percent.png`
...
### `Residuals Versus Predicted__Bagging Regressor__ICE_percent.png`
...
### `Residuals Versus Thickness__Bagging Regressor__ICE_percent.png`
