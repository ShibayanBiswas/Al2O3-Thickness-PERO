# Plot Notes — `models/diagnostics_plots/Bagging Regressor/Initial Reversible Capacity_mAh_g at 0.1C/Residuals`
...
### `Absolute Error Versus Thickness__Bagging Regressor__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Actual__Bagging Regressor__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Predicted__Bagging Regressor__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Thickness__Bagging Regressor__Initial Reversible Capacity_mAh_g at 0.1C.png`
