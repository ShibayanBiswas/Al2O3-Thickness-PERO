# Plot Notes — `models/diagnostics_plots/Bagging Regressor/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Bagging Regressor__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Bagging Regressor__Highest Capacity Retention_percent.png`
