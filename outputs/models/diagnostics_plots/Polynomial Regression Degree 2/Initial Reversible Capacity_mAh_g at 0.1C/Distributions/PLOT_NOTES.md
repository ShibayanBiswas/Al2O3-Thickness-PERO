# Plot Notes — `models/diagnostics_plots/Polynomial Regression Degree 2/Initial Reversible Capacity_mAh_g at 0.1C/Distributions`
...
### `Predicted And Actual Density__Polynomial Regression Degree 2__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `QQ Plot__Polynomial Regression Degree 2__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Box Plot__Polynomial Regression Degree 2__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Distribution__Polynomial Regression Degree 2__Initial Reversible Capacity_mAh_g at 0.1C.png`
