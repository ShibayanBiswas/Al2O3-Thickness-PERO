# Plot Notes — `models/diagnostics_plots/Polynomial Regression Degree 2/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__Polynomial Regression Degree 2__Highest Capacity Retention_percent.png`
...
### `QQ Plot__Polynomial Regression Degree 2__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__Polynomial Regression Degree 2__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__Polynomial Regression Degree 2__Highest Capacity Retention_percent.png`
