# Plot Notes — `models/diagnostics_plots/Polynomial Regression Degree 2/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Polynomial Regression Degree 2__ICE_percent.png`
...
### `QQ Plot__Polynomial Regression Degree 2__ICE_percent.png`
...
### `Residual Box Plot__Polynomial Regression Degree 2__ICE_percent.png`
...
### `Residual Distribution__Polynomial Regression Degree 2__ICE_percent.png`
