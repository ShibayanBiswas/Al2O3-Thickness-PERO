# Plot Notes — `models/diagnostics_plots/Polynomial Ridge Degree 3/Initial Reversible Capacity_mAh_g at 0.1C/Distributions`
...
### `Predicted And Actual Density__Polynomial Ridge Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `QQ Plot__Polynomial Ridge Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Box Plot__Polynomial Ridge Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Distribution__Polynomial Ridge Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
