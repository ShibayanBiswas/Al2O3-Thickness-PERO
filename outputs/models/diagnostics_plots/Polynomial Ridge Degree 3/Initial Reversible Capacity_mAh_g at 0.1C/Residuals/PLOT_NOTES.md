# Plot Notes — `models/diagnostics_plots/Polynomial Ridge Degree 3/Initial Reversible Capacity_mAh_g at 0.1C/Residuals`
...
### `Absolute Error Versus Thickness__Polynomial Ridge Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Actual__Polynomial Ridge Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Predicted__Polynomial Ridge Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Thickness__Polynomial Ridge Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
