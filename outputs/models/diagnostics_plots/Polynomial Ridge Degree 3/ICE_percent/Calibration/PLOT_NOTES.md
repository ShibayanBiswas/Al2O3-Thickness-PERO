# Plot Notes — `models/diagnostics_plots/Polynomial Ridge Degree 3/ICE_percent/Calibration`
...
### `Parity Plot__Polynomial Ridge Degree 3__ICE_percent.png`
...
### `Sorted Actual And Predicted__Polynomial Ridge Degree 3__ICE_percent.png`
