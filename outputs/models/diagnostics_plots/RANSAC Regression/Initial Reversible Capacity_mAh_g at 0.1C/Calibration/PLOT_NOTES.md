# Plot Notes — `models/diagnostics_plots/RANSAC Regression/Initial Reversible Capacity_mAh_g at 0.1C/Calibration`
...
### `Parity Plot__RANSAC Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Sorted Actual And Predicted__RANSAC Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
