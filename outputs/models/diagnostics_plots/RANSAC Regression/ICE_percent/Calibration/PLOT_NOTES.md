# Plot Notes — `models/diagnostics_plots/RANSAC Regression/ICE_percent/Calibration`
...
### `Parity Plot__RANSAC Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__RANSAC Regression__ICE_percent.png`
