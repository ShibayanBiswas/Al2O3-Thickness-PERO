# Plot Notes — `models/diagnostics_plots/RANSAC Regression/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__RANSAC Regression__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__RANSAC Regression__Highest Capacity Retention_percent.png`
