# Plot Notes — `models/diagnostics_plots/RANSAC Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__RANSAC Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__RANSAC Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__RANSAC Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__RANSAC Regression__Highest Capacity Retention_percent.png`
