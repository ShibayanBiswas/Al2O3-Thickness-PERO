# Plot Notes — `models/diagnostics_plots/RANSAC Regression/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__RANSAC Regression__Highest Capacity Retention_percent.png`
...
### `QQ Plot__RANSAC Regression__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__RANSAC Regression__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__RANSAC Regression__Highest Capacity Retention_percent.png`
