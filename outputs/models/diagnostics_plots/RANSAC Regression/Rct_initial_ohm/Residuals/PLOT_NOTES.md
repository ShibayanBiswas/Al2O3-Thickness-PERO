# Plot Notes — `models/diagnostics_plots/RANSAC Regression/Rct_initial_ohm/Residuals`
...
### `Absolute Error Versus Thickness__RANSAC Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Actual__RANSAC Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Predicted__RANSAC Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Thickness__RANSAC Regression__Rct_initial_ohm.png`
