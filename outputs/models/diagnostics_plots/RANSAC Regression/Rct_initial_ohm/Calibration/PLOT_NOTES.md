# Plot Notes — `models/diagnostics_plots/RANSAC Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__RANSAC Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__RANSAC Regression__Rct_initial_ohm.png`
