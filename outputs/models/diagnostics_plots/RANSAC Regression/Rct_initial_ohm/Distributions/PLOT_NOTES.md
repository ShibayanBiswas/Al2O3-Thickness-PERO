# Plot Notes — `models/diagnostics_plots/RANSAC Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__RANSAC Regression__Rct_initial_ohm.png`
...
### `QQ Plot__RANSAC Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__RANSAC Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__RANSAC Regression__Rct_initial_ohm.png`
