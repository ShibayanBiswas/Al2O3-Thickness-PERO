# Plot Notes — `models/diagnostics_plots/Lasso Regression/ICE_percent/Calibration`
...
### `Parity Plot__Lasso Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__Lasso Regression__ICE_percent.png`
