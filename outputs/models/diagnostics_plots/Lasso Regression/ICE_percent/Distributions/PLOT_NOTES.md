# Plot Notes — `models/diagnostics_plots/Lasso Regression/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Lasso Regression__ICE_percent.png`
...
### `QQ Plot__Lasso Regression__ICE_percent.png`
...
### `Residual Box Plot__Lasso Regression__ICE_percent.png`
...
### `Residual Distribution__Lasso Regression__ICE_percent.png`
