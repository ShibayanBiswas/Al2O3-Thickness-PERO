# Plot Notes — `models/diagnostics_plots/Lasso Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Lasso Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Lasso Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Lasso Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Lasso Regression__Highest Capacity Retention_percent.png`
