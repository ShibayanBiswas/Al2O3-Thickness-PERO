# Plot Notes — `models/diagnostics_plots/Lasso Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Lasso Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Lasso Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Lasso Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Lasso Regression__Rct_initial_ohm.png`
