# Plot Notes — `models/diagnostics_plots/Lasso Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Lasso Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Lasso Regression__Rct_initial_ohm.png`
