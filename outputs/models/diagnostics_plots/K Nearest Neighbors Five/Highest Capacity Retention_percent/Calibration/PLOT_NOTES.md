# Plot Notes — `models/diagnostics_plots/K Nearest Neighbors Five/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__K Nearest Neighbors Five__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__K Nearest Neighbors Five__Highest Capacity Retention_percent.png`
