# Plot Notes — `models/diagnostics_plots/K Nearest Neighbors Five/Initial Reversible Capacity_mAh_g at 0.1C/Residuals`
...
### `Absolute Error Versus Thickness__K Nearest Neighbors Five__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Actual__K Nearest Neighbors Five__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Predicted__K Nearest Neighbors Five__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Thickness__K Nearest Neighbors Five__Initial Reversible Capacity_mAh_g at 0.1C.png`
