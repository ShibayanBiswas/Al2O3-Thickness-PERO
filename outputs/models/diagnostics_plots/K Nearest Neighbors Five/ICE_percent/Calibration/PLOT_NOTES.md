# Plot Notes — `models/diagnostics_plots/K Nearest Neighbors Five/ICE_percent/Calibration`
...
### `Parity Plot__K Nearest Neighbors Five__ICE_percent.png`
...
### `Sorted Actual And Predicted__K Nearest Neighbors Five__ICE_percent.png`
