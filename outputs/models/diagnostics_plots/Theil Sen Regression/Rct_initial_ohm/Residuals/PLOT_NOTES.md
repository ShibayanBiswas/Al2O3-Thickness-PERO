# Plot Notes — `models/diagnostics_plots/Theil Sen Regression/Rct_initial_ohm/Residuals`
...
### `Absolute Error Versus Thickness__Theil Sen Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Actual__Theil Sen Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Predicted__Theil Sen Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Thickness__Theil Sen Regression__Rct_initial_ohm.png`
