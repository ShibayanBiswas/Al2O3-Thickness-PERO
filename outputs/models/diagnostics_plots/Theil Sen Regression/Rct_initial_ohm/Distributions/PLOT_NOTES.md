# Plot Notes — `models/diagnostics_plots/Theil Sen Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Theil Sen Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Theil Sen Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Theil Sen Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Theil Sen Regression__Rct_initial_ohm.png`
