# Plot Notes — `models/diagnostics_plots/Theil Sen Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Theil Sen Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Theil Sen Regression__Rct_initial_ohm.png`
