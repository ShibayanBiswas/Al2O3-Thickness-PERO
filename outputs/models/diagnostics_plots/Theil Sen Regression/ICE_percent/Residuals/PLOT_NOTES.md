# Plot Notes — `models/diagnostics_plots/Theil Sen Regression/ICE_percent/Residuals`
...
### `Absolute Error Versus Thickness__Theil Sen Regression__ICE_percent.png`
...
### `Residuals Versus Actual__Theil Sen Regression__ICE_percent.png`
...
### `Residuals Versus Predicted__Theil Sen Regression__ICE_percent.png`
...
### `Residuals Versus Thickness__Theil Sen Regression__ICE_percent.png`
