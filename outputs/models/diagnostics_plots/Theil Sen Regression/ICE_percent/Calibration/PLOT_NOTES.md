# Plot Notes — `models/diagnostics_plots/Theil Sen Regression/ICE_percent/Calibration`
...
### `Parity Plot__Theil Sen Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__Theil Sen Regression__ICE_percent.png`
