# Plot Notes — `models/diagnostics_plots/Theil Sen Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Theil Sen Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Theil Sen Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Theil Sen Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Theil Sen Regression__Highest Capacity Retention_percent.png`
