# Plot Notes — `models/diagnostics_plots/Theil Sen Regression/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Theil Sen Regression__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Theil Sen Regression__Highest Capacity Retention_percent.png`
