# Plot Notes — `models/diagnostics_plots/Categorical Boosting/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Categorical Boosting__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Categorical Boosting__Highest Capacity Retention_percent.png`
