# Plot Notes — `models/diagnostics_plots/Categorical Boosting/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Categorical Boosting__ICE_percent.png`
...
### `QQ Plot__Categorical Boosting__ICE_percent.png`
...
### `Residual Box Plot__Categorical Boosting__ICE_percent.png`
...
### `Residual Distribution__Categorical Boosting__ICE_percent.png`
