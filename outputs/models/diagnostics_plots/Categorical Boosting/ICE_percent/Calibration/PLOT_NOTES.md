# Plot Notes — `models/diagnostics_plots/Categorical Boosting/ICE_percent/Calibration`
...
### `Parity Plot__Categorical Boosting__ICE_percent.png`
...
### `Sorted Actual And Predicted__Categorical Boosting__ICE_percent.png`
