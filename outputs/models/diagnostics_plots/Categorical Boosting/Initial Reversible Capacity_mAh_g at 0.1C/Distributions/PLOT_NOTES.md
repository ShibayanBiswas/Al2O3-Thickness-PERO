# Plot Notes — `models/diagnostics_plots/Categorical Boosting/Initial Reversible Capacity_mAh_g at 0.1C/Distributions`
...
### `Predicted And Actual Density__Categorical Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `QQ Plot__Categorical Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Box Plot__Categorical Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Distribution__Categorical Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
