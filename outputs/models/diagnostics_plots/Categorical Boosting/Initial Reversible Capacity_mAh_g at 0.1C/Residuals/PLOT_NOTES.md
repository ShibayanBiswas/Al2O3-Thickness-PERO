# Plot Notes — `models/diagnostics_plots/Categorical Boosting/Initial Reversible Capacity_mAh_g at 0.1C/Residuals`
...
### `Absolute Error Versus Thickness__Categorical Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Actual__Categorical Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Predicted__Categorical Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Thickness__Categorical Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
