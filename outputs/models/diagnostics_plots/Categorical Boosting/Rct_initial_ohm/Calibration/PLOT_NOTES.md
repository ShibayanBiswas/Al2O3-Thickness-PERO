# Plot Notes — `models/diagnostics_plots/Categorical Boosting/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Categorical Boosting__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Categorical Boosting__Rct_initial_ohm.png`
