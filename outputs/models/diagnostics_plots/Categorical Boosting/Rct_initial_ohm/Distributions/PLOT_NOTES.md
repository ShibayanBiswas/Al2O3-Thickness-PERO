# Plot Notes — `models/diagnostics_plots/Categorical Boosting/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Categorical Boosting__Rct_initial_ohm.png`
...
### `QQ Plot__Categorical Boosting__Rct_initial_ohm.png`
...
### `Residual Box Plot__Categorical Boosting__Rct_initial_ohm.png`
...
### `Residual Distribution__Categorical Boosting__Rct_initial_ohm.png`
