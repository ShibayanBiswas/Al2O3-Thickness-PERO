# Plot Notes — `models/diagnostics_plots/Decision Tree/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Decision Tree__ICE_percent.png`
...
### `QQ Plot__Decision Tree__ICE_percent.png`
...
### `Residual Box Plot__Decision Tree__ICE_percent.png`
...
### `Residual Distribution__Decision Tree__ICE_percent.png`
