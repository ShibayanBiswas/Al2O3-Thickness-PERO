# Plot Notes — `models/diagnostics_plots/Decision Tree/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Decision Tree__Rct_initial_ohm.png`
...
### `QQ Plot__Decision Tree__Rct_initial_ohm.png`
...
### `Residual Box Plot__Decision Tree__Rct_initial_ohm.png`
...
### `Residual Distribution__Decision Tree__Rct_initial_ohm.png`
