# Plot Notes — `models/diagnostics_plots/Decision Tree/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Decision Tree__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Decision Tree__Rct_initial_ohm.png`
