# Plot Notes — `models/diagnostics_plots/Decision Tree/Initial Reversible Capacity_mAh_g at 0.1C/Distributions`
...
### `Predicted And Actual Density__Decision Tree__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `QQ Plot__Decision Tree__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Box Plot__Decision Tree__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Distribution__Decision Tree__Initial Reversible Capacity_mAh_g at 0.1C.png`
