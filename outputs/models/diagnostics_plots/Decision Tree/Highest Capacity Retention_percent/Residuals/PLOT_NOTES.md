# Plot Notes — `models/diagnostics_plots/Decision Tree/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Decision Tree__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Decision Tree__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Decision Tree__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Decision Tree__Highest Capacity Retention_percent.png`
