# Plot Notes — `models/diagnostics_plots/Decision Tree/Highest Capacity Retention_percent/Calibration`
...
### `Parity Plot__Decision Tree__Highest Capacity Retention_percent.png`
...
### `Sorted Actual And Predicted__Decision Tree__Highest Capacity Retention_percent.png`
