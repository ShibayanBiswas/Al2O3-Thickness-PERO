# Plot Notes — `models/diagnostics_plots/Extra Trees/ICE_percent/Calibration`
...
### `Parity Plot__Extra Trees__ICE_percent.png`
...
### `Sorted Actual And Predicted__Extra Trees__ICE_percent.png`
