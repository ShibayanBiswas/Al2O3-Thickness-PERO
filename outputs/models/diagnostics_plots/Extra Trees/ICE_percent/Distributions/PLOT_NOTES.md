# Plot Notes — `models/diagnostics_plots/Extra Trees/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Extra Trees__ICE_percent.png`
...
### `QQ Plot__Extra Trees__ICE_percent.png`
...
### `Residual Box Plot__Extra Trees__ICE_percent.png`
...
### `Residual Distribution__Extra Trees__ICE_percent.png`
