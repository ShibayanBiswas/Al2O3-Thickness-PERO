# Plot Notes — `models/diagnostics_plots/Extra Trees/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Extra Trees__Rct_initial_ohm.png`
...
### `QQ Plot__Extra Trees__Rct_initial_ohm.png`
...
### `Residual Box Plot__Extra Trees__Rct_initial_ohm.png`
...
### `Residual Distribution__Extra Trees__Rct_initial_ohm.png`
