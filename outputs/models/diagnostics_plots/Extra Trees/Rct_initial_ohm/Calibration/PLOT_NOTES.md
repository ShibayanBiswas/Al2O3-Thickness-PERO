# Plot Notes — `models/diagnostics_plots/Extra Trees/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Extra Trees__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Extra Trees__Rct_initial_ohm.png`
