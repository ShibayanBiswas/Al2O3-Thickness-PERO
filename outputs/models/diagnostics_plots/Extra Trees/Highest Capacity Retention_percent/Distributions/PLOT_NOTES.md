# Plot Notes — `models/diagnostics_plots/Extra Trees/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__Extra Trees__Highest Capacity Retention_percent.png`
...
### `QQ Plot__Extra Trees__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__Extra Trees__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__Extra Trees__Highest Capacity Retention_percent.png`
