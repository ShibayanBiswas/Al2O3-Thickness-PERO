# Plot Notes — `models/diagnostics_plots/Support Vector Regression/ICE_percent/Residuals`
...
### `Absolute Error Versus Thickness__Support Vector Regression__ICE_percent.png`
...
### `Residuals Versus Actual__Support Vector Regression__ICE_percent.png`
...
### `Residuals Versus Predicted__Support Vector Regression__ICE_percent.png`
...
### `Residuals Versus Thickness__Support Vector Regression__ICE_percent.png`
