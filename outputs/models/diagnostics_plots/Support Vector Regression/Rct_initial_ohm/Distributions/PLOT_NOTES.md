# Plot Notes — `models/diagnostics_plots/Support Vector Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Support Vector Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Support Vector Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Support Vector Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Support Vector Regression__Rct_initial_ohm.png`
