# Plot Notes — `models/diagnostics_plots/Support Vector Regression/Rct_initial_ohm/Residuals`
...
### `Absolute Error Versus Thickness__Support Vector Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Actual__Support Vector Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Predicted__Support Vector Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Thickness__Support Vector Regression__Rct_initial_ohm.png`
