# Plot Notes — `models/diagnostics_plots/Support Vector Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Support Vector Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Support Vector Regression__Rct_initial_ohm.png`
