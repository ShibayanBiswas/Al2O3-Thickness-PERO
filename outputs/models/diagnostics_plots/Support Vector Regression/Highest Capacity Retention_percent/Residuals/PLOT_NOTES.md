# Plot Notes — `models/diagnostics_plots/Support Vector Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Support Vector Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Support Vector Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Support Vector Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Support Vector Regression__Highest Capacity Retention_percent.png`
