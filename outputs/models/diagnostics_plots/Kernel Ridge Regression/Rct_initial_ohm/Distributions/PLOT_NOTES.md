# Plot Notes — `models/diagnostics_plots/Kernel Ridge Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Kernel Ridge Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Kernel Ridge Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Kernel Ridge Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Kernel Ridge Regression__Rct_initial_ohm.png`
