# Plot Notes — `models/diagnostics_plots/Kernel Ridge Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Kernel Ridge Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Kernel Ridge Regression__Rct_initial_ohm.png`
