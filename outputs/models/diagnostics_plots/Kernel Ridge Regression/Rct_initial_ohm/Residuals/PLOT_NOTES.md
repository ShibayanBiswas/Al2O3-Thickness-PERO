# Plot Notes — `models/diagnostics_plots/Kernel Ridge Regression/Rct_initial_ohm/Residuals`
...
### `Absolute Error Versus Thickness__Kernel Ridge Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Actual__Kernel Ridge Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Predicted__Kernel Ridge Regression__Rct_initial_ohm.png`
...
### `Residuals Versus Thickness__Kernel Ridge Regression__Rct_initial_ohm.png`
