# Plot Notes — `models/diagnostics_plots/Kernel Ridge Regression/Initial Reversible Capacity_mAh_g at 0.1C/Calibration`
...
### `Parity Plot__Kernel Ridge Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Sorted Actual And Predicted__Kernel Ridge Regression__Initial Reversible Capacity_mAh_g at 0.1C.png`
