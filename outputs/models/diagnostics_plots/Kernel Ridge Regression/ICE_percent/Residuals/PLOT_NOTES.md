# Plot Notes — `models/diagnostics_plots/Kernel Ridge Regression/ICE_percent/Residuals`
...
### `Absolute Error Versus Thickness__Kernel Ridge Regression__ICE_percent.png`
...
### `Residuals Versus Actual__Kernel Ridge Regression__ICE_percent.png`
...
### `Residuals Versus Predicted__Kernel Ridge Regression__ICE_percent.png`
...
### `Residuals Versus Thickness__Kernel Ridge Regression__ICE_percent.png`
