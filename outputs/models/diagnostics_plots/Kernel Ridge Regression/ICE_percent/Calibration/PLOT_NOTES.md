# Plot Notes — `models/diagnostics_plots/Kernel Ridge Regression/ICE_percent/Calibration`
...
### `Parity Plot__Kernel Ridge Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__Kernel Ridge Regression__ICE_percent.png`
