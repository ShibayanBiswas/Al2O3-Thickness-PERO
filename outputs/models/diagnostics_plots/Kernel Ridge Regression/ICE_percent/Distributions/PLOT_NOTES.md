# Plot Notes — `models/diagnostics_plots/Kernel Ridge Regression/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Kernel Ridge Regression__ICE_percent.png`
...
### `QQ Plot__Kernel Ridge Regression__ICE_percent.png`
...
### `Residual Box Plot__Kernel Ridge Regression__ICE_percent.png`
...
### `Residual Distribution__Kernel Ridge Regression__ICE_percent.png`
