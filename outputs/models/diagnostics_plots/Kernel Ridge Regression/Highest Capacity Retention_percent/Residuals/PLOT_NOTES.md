# Plot Notes — `models/diagnostics_plots/Kernel Ridge Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Kernel Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Kernel Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Kernel Ridge Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Kernel Ridge Regression__Highest Capacity Retention_percent.png`
