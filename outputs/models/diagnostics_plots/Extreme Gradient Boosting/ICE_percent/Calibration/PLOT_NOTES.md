# Plot Notes — `models/diagnostics_plots/Extreme Gradient Boosting/ICE_percent/Calibration`
...
### `Parity Plot__Extreme Gradient Boosting__ICE_percent.png`
...
### `Sorted Actual And Predicted__Extreme Gradient Boosting__ICE_percent.png`
