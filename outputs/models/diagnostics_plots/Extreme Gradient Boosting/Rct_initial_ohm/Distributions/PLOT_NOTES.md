# Plot Notes — `models/diagnostics_plots/Extreme Gradient Boosting/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Extreme Gradient Boosting__Rct_initial_ohm.png`
...
### `QQ Plot__Extreme Gradient Boosting__Rct_initial_ohm.png`
...
### `Residual Box Plot__Extreme Gradient Boosting__Rct_initial_ohm.png`
...
### `Residual Distribution__Extreme Gradient Boosting__Rct_initial_ohm.png`
