# Plot Notes — `models/diagnostics_plots/Extreme Gradient Boosting/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Extreme Gradient Boosting__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Extreme Gradient Boosting__Rct_initial_ohm.png`
