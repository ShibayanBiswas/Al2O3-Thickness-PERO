# Plot Notes — `models/diagnostics_plots/Extreme Gradient Boosting/Rct_initial_ohm/Residuals`
...
### `Absolute Error Versus Thickness__Extreme Gradient Boosting__Rct_initial_ohm.png`
...
### `Residuals Versus Actual__Extreme Gradient Boosting__Rct_initial_ohm.png`
...
### `Residuals Versus Predicted__Extreme Gradient Boosting__Rct_initial_ohm.png`
...
### `Residuals Versus Thickness__Extreme Gradient Boosting__Rct_initial_ohm.png`
