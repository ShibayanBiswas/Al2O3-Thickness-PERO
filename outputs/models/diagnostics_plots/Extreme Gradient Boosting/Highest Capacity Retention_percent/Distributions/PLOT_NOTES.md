# Plot Notes — `models/diagnostics_plots/Extreme Gradient Boosting/Highest Capacity Retention_percent/Distributions`
...
### `Predicted And Actual Density__Extreme Gradient Boosting__Highest Capacity Retention_percent.png`
...
### `QQ Plot__Extreme Gradient Boosting__Highest Capacity Retention_percent.png`
...
### `Residual Box Plot__Extreme Gradient Boosting__Highest Capacity Retention_percent.png`
...
### `Residual Distribution__Extreme Gradient Boosting__Highest Capacity Retention_percent.png`
