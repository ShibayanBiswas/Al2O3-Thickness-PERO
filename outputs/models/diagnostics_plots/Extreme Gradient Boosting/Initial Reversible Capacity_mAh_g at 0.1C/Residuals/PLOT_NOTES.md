# Plot Notes — `models/diagnostics_plots/Extreme Gradient Boosting/Initial Reversible Capacity_mAh_g at 0.1C/Residuals`
...
### `Absolute Error Versus Thickness__Extreme Gradient Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Actual__Extreme Gradient Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Predicted__Extreme Gradient Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residuals Versus Thickness__Extreme Gradient Boosting__Initial Reversible Capacity_mAh_g at 0.1C.png`
