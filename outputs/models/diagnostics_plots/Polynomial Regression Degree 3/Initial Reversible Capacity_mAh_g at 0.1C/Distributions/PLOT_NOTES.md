# Plot Notes — `models/diagnostics_plots/Polynomial Regression Degree 3/Initial Reversible Capacity_mAh_g at 0.1C/Distributions`
...
### `Predicted And Actual Density__Polynomial Regression Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `QQ Plot__Polynomial Regression Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Box Plot__Polynomial Regression Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
...
### `Residual Distribution__Polynomial Regression Degree 3__Initial Reversible Capacity_mAh_g at 0.1C.png`
