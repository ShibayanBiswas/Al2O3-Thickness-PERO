# Plot Notes — `models/diagnostics_plots/Polynomial Regression Degree 3/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Polynomial Regression Degree 3__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Polynomial Regression Degree 3__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Polynomial Regression Degree 3__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Polynomial Regression Degree 3__Highest Capacity Retention_percent.png`
