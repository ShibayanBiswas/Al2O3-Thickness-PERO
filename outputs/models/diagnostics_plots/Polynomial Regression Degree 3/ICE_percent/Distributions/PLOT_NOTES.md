# Plot Notes — `models/diagnostics_plots/Polynomial Regression Degree 3/ICE_percent/Distributions`
...
### `Predicted And Actual Density__Polynomial Regression Degree 3__ICE_percent.png`
...
### `QQ Plot__Polynomial Regression Degree 3__ICE_percent.png`
...
### `Residual Box Plot__Polynomial Regression Degree 3__ICE_percent.png`
...
### `Residual Distribution__Polynomial Regression Degree 3__ICE_percent.png`
