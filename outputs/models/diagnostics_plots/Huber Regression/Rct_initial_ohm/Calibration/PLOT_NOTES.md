# Plot Notes — `models/diagnostics_plots/Huber Regression/Rct_initial_ohm/Calibration`
...
### `Parity Plot__Huber Regression__Rct_initial_ohm.png`
...
### `Sorted Actual And Predicted__Huber Regression__Rct_initial_ohm.png`
