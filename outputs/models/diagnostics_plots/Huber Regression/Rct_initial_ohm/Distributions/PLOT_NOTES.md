# Plot Notes — `models/diagnostics_plots/Huber Regression/Rct_initial_ohm/Distributions`
...
### `Predicted And Actual Density__Huber Regression__Rct_initial_ohm.png`
...
### `QQ Plot__Huber Regression__Rct_initial_ohm.png`
...
### `Residual Box Plot__Huber Regression__Rct_initial_ohm.png`
...
### `Residual Distribution__Huber Regression__Rct_initial_ohm.png`
