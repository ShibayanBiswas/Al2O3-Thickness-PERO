# Plot Notes — `models/diagnostics_plots/Huber Regression/Highest Capacity Retention_percent/Residuals`
...
### `Absolute Error Versus Thickness__Huber Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Actual__Huber Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Predicted__Huber Regression__Highest Capacity Retention_percent.png`
...
### `Residuals Versus Thickness__Huber Regression__Highest Capacity Retention_percent.png`
