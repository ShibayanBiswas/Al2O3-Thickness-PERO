# Plot Notes — `models/diagnostics_plots/Huber Regression/ICE_percent/Calibration`
...
### `Parity Plot__Huber Regression__ICE_percent.png`
...
### `Sorted Actual And Predicted__Huber Regression__ICE_percent.png`
